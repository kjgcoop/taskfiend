        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-[#202020] border border-gray-700 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <!-- Parent Task -->
                    <div>
                        <span class="text-sm font-medium text-gray-500">Parent Task
                            @if($task->parent)
                ...
                <div class="p-6">
                    ...
                    <div x-show="tab === 'attachments'">
                        ...
                        <form method="POST" action="{{ route('attachments.store', $task) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="flex items-center gap-2" x-data="multiFileInput">
                                <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <div class="space-y-2">
                                @foreach($referencingTasks as $ref)
                                    <a href="{{ route('tasks.show', $ref) }}"
                                       class="flex items-center gap-3 p-3 rounded-lg bg-gray-700 border border-gray-600 hover:bg-gray-600 transition group">
                                        <span class="flex-1 min-w-0">
                                            ...
                                            <span class="flex items-center gap-2 mt-0.5">
                                                ...
                                                @if($ref->project)
                                                    <span class="text-xs text-gray-500">{{ $ref->project->name }}</span>
                                                @endif
                                            </span>
                                        </span>
