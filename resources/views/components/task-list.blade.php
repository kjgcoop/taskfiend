...
<div class="space-y-2">
    @forelse($tasks as $task)
        ...
        @endphp
        <div class="bg-[#002200] p-4 rounded-lg shadow hover:shadow-md transition border border-gray-700"
             data-filterable
        ...
        @endif
    @empty
        <div class="bg-[#002200] p-8 rounded-lg text-center text-gray-400 border border-gray-700">
            No tasks found.
        </div>
    @endforelse
</div>
