        ...
        <div>
            <form action="{{ route('import.all') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex items-center space-x-4">
                    <input type="file" name="import_file" accept=".zip" required class="block w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-gray-700 file:text-gray-100 hover:file:bg-gray-600 bg-[#003300] border border-gray-600 rounded-md">
