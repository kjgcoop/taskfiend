<nav x-data="{ open: false }" class="bg-[#0a1a0a] border-b border-gray-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-300 bg-[#0a1a0a] hover:text-gray-100 focus:outline-none transition ease-in-out duration-150">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if($otherLinksFiles->isNotEmpty())
                ...
                <div x-data="{ otherLinksOpen: false }" class="border-t border-gray-700">
                    ...
                    <div x-show="otherLinksOpen" x-transition class="bg-[#050f05]">
                        @foreach($otherLinksFiles as $filename => $displayName)
