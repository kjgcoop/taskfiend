<x-app-layout>
    ...
    <div class="py-12" x-data="{ showImportForm: false, templateFile: null, projectName: '' }">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div x-show="showImportForm" x-cloak class="bg-black border border-gray-700 p-6 rounded-lg shadow">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="file" name="template_file" accept=".zip" required
                                   ...
                                   class="block w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-gray-700 file:text-gray-100 hover:file:bg-gray-600 bg-black border border-gray-600 rounded-md">
                        </div>
                        <div>
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                @forelse($projects as $project)
                    <div class="bg-black border border-gray-700 p-6 rounded-lg shadow hover:shadow-md transition cursor-pointer"
                ...
                @empty
                    <div class="col-span-full bg-black border border-gray-700 p-8 rounded-lg text-center text-gray-500">
