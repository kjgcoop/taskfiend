...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/day/export-png', [DashboardController::class, 'exportDayPng'])->name('day.export-png');
    ...
    Route::post('/projects/create-from-markdown', [DataExportController::class, 'createFromMarkdown'])->name('projects.create-from-markdown');
