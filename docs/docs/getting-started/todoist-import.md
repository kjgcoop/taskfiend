This was the spec I had Claude write that I fed to Claude Code. I haven't yet converted it into a how-to that humans should read, but hopefully this'll give you some idea of how the import works.
