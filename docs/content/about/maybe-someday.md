...
As described in [Day Export](/docs/features/day-export/#Export-PNG), I export my day's tasks to PNG to print on a receipt printer. This prevents me from keeping my nose in my phone all day.
